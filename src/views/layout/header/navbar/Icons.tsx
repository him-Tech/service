export function AvailableFunding() {
  return (
    <svg width="18" height="19" version="1.1" id="fi_482506" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 469.333 469.333">
      <g>
        <g>
          <path
            d="M277.333,89.144V52.607C277.333-17.536,0-17.536,0,52.607v213.706c0,27.574,43.163,44.763,95.089,50.874
...
export function DashboardIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="18" height="19" x="0" y="0" viewBox="0 0 512 512" className="">
      <g>
        <path
...
export function HowItWorksIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="18" height="19" x="0" y="0" viewBox="0 0 24 24">
      <g>
        <path
          d="M7 18h10a3 3 0 0 0 3-3V5a3 3 0 0 0-3-3H7a3 3 0 0 0-3 3v14a3 3 0 0 0 3 3h12a1 1 0 0 0 0-2H7a1 1 0 0 1 0-2zM6 5a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H7a3 3 0 0 0-1 .171z"
          fill="#ffffff"
          opacity="1"
          data-original="#000000"
        ></path>
        <path d="M12 14a1 1 0 0 0 1-1v-3a1 1 0 0 0-2 0v3a1 1 0 0 0 1 1z" fill="#ffffff" opacity="1" data-original="#000000"></path>
        <circle cx="12" cy="7" r="1" fill="#ffffff" opacity="1" data-original="#000000"></circle>
      </g>
    </svg>
  );
}
